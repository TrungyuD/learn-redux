...
const GET_LIST_ROLE =  "GET_LIST_ROLE";
describe('actions', () => {
  it('GET_LIST_ROLE action in redux', () => {
    const dataRole =  [
            {
                "id": "modality_resource_manager",
            "uuid": "52e8c0f9-c124-46a2-9875-24ffbf1bf126",
            "name": "Modality Resource Manager",
            "description": "Modality Resource Manager",
            "updatable": null,
            "authorities": [
                {
                    "id": "center_delete",
        ...
        {
            "id": "rental_test",
            "uuid": "fd06eff5-f83f-4a59-819b-33488f0279b8",
            "name": "rental test",
            "description": null,
            "updatable": null,
            "authorities": [
        ...
        {
            "id": "telerad_portal_manager",
            "uuid": "f0ed4647-59ca-47df-9166-ccab3d52d3fc",
            "name": "Telerad portal manager",
            "description": "Telerad portal manager",
            "updatable": null,
            "authorities": [
                {
                    "id": "center_staff_delete",
        ...
        {
            "id": "center_staff",
            "uuid": "328bde1e-a9ac-41a3-8899-917f53c97a9e",
            "name": "Health Center Staff",
            "description": null,
            "updatable": null,
            "authorities": [
                {
        ...
        {
            "id": "tele_operation_manager",
            "uuid": "b74227e6-d8b9-4a4b-829f-9068464fd997",
            "name": "Tele operation manager",
            "description": "Tele operation manager",
            "updatable": null,
            "authorities": [
                {
                    "id": "authority_edit",
        ...
        {
            "id": "sysadmin",
            "uuid": "9f49e5db-18e6-4439-818c-2d244debd583",
        ...
        {
            "id": "irad_center_staff",
            "uuid": "470e5238-1f80-4c7f-80a6-4064cba2afc5",
            "name": "iRAD Center Staff",
            "description": null,
            "updatable": true,
            "authorities": [
                {
        ...
        {
            "id": "sys_2_authorities",
            "uuid": "8f3bdfc4-f34a-4664-96b0-7f320b765312",
            "name": "co hai phan quyen",
            "description": "co hai phan queyn",
            "updatable": null,
            "authorities": [
                {
                    "id": "sysadmin",
        ...
        {
            "id": "test_custom_pagination_2",
            "uuid": "70d49854-8bfa-4e09-8c7f-90113aaaa99d",
            "name": "test",
            "description": "test",
            "updatable": null,
            "authorities": [
        ...
        {
            "id": "irad_radiologist",
            "uuid": "5a16c2ef-9f17-4033-b0f4-46e441d6625c",
            "name": "iRAD Radiologist",
            "description": null,
            "updatable": true,
            "authorities": [
                {
        ...
        {
            "id": "manage_resources",
            "uuid": "561a46fa-a3dd-4286-915c-61def6790da1",
        ...
        {
            "id": "modality_resource_viewer",
            "uuid": "009c4ce1-4f12-4874-a65c-5f8d2fd33d44",
            "name": "modality_resource_viewer",
            "description": "modality_resource_viewer",
            "updatable": null,
            "authorities": [
                {
                    "id": "role_get",
    ...
    expect(actions.getListRole(dataRole)).toEqual(expectedAction)
  })
})